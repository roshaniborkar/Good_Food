...
import {
    ...
    ACCOUNT_ADMIN_PRODUCTS as ACCOUNT_ADMIN_PRODUCTS,
    ACCOUNT_ADMIN_USERS,
    ACCOUNT_USER_EDIT,
    ACCOUNT_USER_INFO,
    ACCOUNT_USER_ORDERS
...
import PerfumeList from "./ProductList/ProductList";
                ...
                <Col span={19}>
                    ...
                    {isAdmin ? (
                        <>
                            ...
                            <Route exact path={ACCOUNT_ADMIN_PRODUCTS} component={PerfumeList} />
                            <Route exact path={`${ACCOUNT_ADMIN_PRODUCTS}/:id`} component={EditPerfume} />
