...
import { fetchPerfume, fetchReviewsByPerfumeId } from "../../redux-toolkit/product/product-thunks";
import { resetInputForm } from "../../redux-toolkit/user/user-slice";
import { WEBSOCKET_URL } from "../../constants/urlConstants";
import { resetPerfumeState, setReview } from "../../redux-toolkit/product/product-slice";
...
const Product: FC = (): ReactElement => {
    ...
    const { addToCart } = useCart(perfume?.productId!);
                ...
                <>
                    {isPerfumeError ? (
                        ...
                        <>
                            ...
                            <div style={{ marginTop: 16, height: "50px" }}></div>
                            <ProductReviews
                                reviews={reviews}
