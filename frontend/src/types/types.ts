...
export interface FullPerfumeResponse extends ProductResponse {
    year: number;
    seller: string;
...
export class ReviewResponse {
    ...
    rating: number;
    date: any;
    constructor(data: { id: number; author: string; message: string;rating:number;date:any }) {
        const { id, author, message,rating,date } = data;
        this.id = id;
        this.author = author;
