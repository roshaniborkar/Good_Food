...
import productsSlice, { PerfumesState as ProductsState } from "./redux-toolkit/perfumes/perfumes-slice";
import productSlice, { PerfumeState as ProductState } from "./redux-toolkit/product/product-slice";
